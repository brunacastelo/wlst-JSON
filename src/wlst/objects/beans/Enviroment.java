...
public class Enviroment {
	...
	public Enviroment(String template, String endereco, Domain domain, List<DataSource> dataSources, List<FileStore> fileStores,
			List<JdbcStore> jdbcStores, List<JmsServer> jmsServer, List<JmsModule> jmsModule, String weblogic, String url, String user, List<WorkManager> workManagers,
			List<BridgeTarget> bridgeTargets, List<Bridge> bridges) {
		super();
